...
int main()
{
  ...
  cout << "El número de elementos de la guía es B " << B.size()
  ...
  cout << "_________El resultado ha sido________" << endl;
  cout << B;
 ...
 string cliente = B.clave(TELEFONO); 
 cout << cliente << endl;

 //prueba asigna teléfono
 B.asignaTelefono(cliente, "00000000000");
 cout << "________ tras cambiar el número a " << cliente << "resulta___" << endl;
 cout << B; 
